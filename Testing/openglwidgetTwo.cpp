...
OpenGlWidgetTwo::OpenGlWidgetTwo(QWidget *parent)
...
void OpenGlWidgetTwo::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetTwo::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
