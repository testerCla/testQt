...
OpenGlWidgetEleven::OpenGlWidgetEleven(QWidget *parent)
...
void OpenGlWidgetEleven::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetEleven::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
...
void OpenGlWidgetEleven::paintGL()
{
