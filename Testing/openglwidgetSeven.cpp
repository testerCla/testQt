...
OpenGlWidgetSeven::OpenGlWidgetSeven(QWidget *parent)
...
void OpenGlWidgetSeven::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetSeven::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
...
void OpenGlWidgetSeven::paintGL()
{
