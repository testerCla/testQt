...
OpenGlWidgetOne::OpenGlWidgetOne(QWidget *parent)
...
void OpenGlWidgetOne::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetOne::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
