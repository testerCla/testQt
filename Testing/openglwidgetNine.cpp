...
OpenGlWidgetNine::OpenGlWidgetNine(QWidget *parent)
...
void OpenGlWidgetNine::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetNine::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
