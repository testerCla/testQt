...
OpenGlWidgetFour::OpenGlWidgetFour(QWidget *parent)
...
void OpenGlWidgetFour::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetFour::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
