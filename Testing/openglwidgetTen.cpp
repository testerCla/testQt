...
OpenGlWidgetTen::OpenGlWidgetTen(QWidget *parent)
...
void OpenGlWidgetTen::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetTen::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
