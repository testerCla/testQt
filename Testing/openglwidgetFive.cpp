...
OpenGlWidgetFive::OpenGlWidgetFive(QWidget *parent)
...
void OpenGlWidgetFive::dragEnterEvent(QDragEnterEvent *event)
{
    event->accept();
}

void OpenGlWidgetFive::dropEvent(QDropEvent *event ){ //HOW TO PASS THE GRID LAYOUT HERE (?)
